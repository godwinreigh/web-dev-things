...
#status bar
#to create a backgroud use bd function
#anchor function is use to position a text using directions
...
#sticky function we use it to stretch depende in given direction
status.grid(row=0, column=0, columnspan=3, sticky= W+E)

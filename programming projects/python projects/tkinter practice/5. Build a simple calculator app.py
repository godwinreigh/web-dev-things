...
e = Entry(root, width=35, borderwidth=20, bg='Black', fg='White')
e.grid(row=0, column= 0, columnspan= 3, padx=20, pady=20)
#root.iconbitmap('C:/Users/godwi/Downloads/Wwalczyszyn-Android-Style-Honeycomb-Calculator.ico')

#f_num variable means getting the e variable
...
#lambda function is use to pass a certain string or integer by button
...
button_equal=Button(root, text="=", padx=89, pady=20, borderwidth= 5,command=button_equal)
button_clear=Button(root, text="CLEAR", padx=76, pady=20, borderwidth= 5,command=button_clear)

button_subract= Button(root, text="-", padx=41, pady=20, borderwidth= 5,command=button_subract)
button_multiply= Button(root, text="*", padx=41, pady=20,borderwidth= 5, command=button_multiply)
...
#columnspan function makes one text or button to determine how much to occupy grids
